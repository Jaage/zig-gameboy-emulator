...
pub const Registers = struct {
    ...
    pub fn get_de(self: Registers) u16 {
        return @as(u16, self.e) << 8 | @as(u16, self.d);
    }
    ...
    pub fn get_hl(self: Registers) u16 {
        return @as(u16, self.l) << 8 | @as(u16, self.h);
    }
...
test "Registers.get_af" {
    try testing.expect(test_register.get_af() == 0b1010000010101010);
}

test "Registers.get_bc" {
    try testing.expect(test_register.get_bc() == 0b1010001010101011);
}

test "Registers.get_de" {
    try testing.expect(test_register.get_de() == 0b1110101010001010);
}

test "Registers.get_hl" {
    try testing.expect(test_register.get_hl() == 0b1010100010111010);
}
